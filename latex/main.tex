...
\section{System Design and Architecture}
  \subsection{Privacy Budget Management System Architecture}
    ...
    \subsection{Uniform Random Number Generator}
      ...
      \textit{$\langle$ TODO: discuss block diagram$\rangle$}
  ...
  \subsection{Evaluation of Hardware Entropy Source}
    ...
    \subsubsection{Results}
      ...
      % \end{figure}
        ...
        \begin{figure}[H]
          \centering
          \subfloat[Time domain]{\includegraphics[width=0.7\textwidth]{fig/tp2_yt.png}}
          \qquad
          \subfloat[Frequency domain]{\includegraphics[width=0.7\textwidth]{fig/tp2_f_wide.png}}
