...
\section{Technologies and Techniques Used} \label{section:tech}
  \subsection{GitHub} \label{subsection:GitHub}
    ...
    \begin{itemize}
        \item Main project repository containing Python simulations/tests, Verilog templates and C code:\\
  ...
  \subsection{Main Project Repository Structure and Build System} \label{subsection:build_system}
    \textit{TODO: talk about C program, parameterised verilog}
